                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title">Sửa danh mục chính</div>
                                    <hr />
                                    <form method="POST" name="update_form" action="{{ route('main_category.update',$main_category->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
