...
@section('content')
            <div class="content-wrapper">
                <div class="container-fluid">
                    @include('admin.includes.bread_crumb', ['title' => 'ALL Size'])
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @foreach ($collection as $key=>$item)
                                                    <tr class="admin_size_individual_body">
                                                        ...
                                                        <td scope="row">
                                                            <div class="text-right">
                                                               ...
                                                               <a type="button" href="{{ route('size.destroy',$item->id) }}" data-parent=".admin_size_individual_body"
